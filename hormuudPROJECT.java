...
public class hormuuudPROJECT {
    // Array to store transaction history
    private static final String[] transactionHistory = new String[10];
    private static int transactionCount = 0;

    // Authentication details
    private static final int USER_PIN = 4142;
    private static final int ACCOUNT_NUMBER = 8094142;
    private static final int BUSINESS_ID = 4241;

    // Initial balances
    private static int mobileBalance = 789;
    private static int bankAccountBalance = 2288;
    ...
    public static void main(String[] args) {
        ...
        switch (selectedOption) {
            case 1:
                addTransaction("Checked balance: $" + mobileBalance);
                ...
                if (airtimeChoice == 1) {
                    ...
                    if (rechargeAmount > 0 && rechargeAmount <= mobileBalance) {
                        ...
                        if (confirmation == 1) {
                            ...
                            addTransaction("Self recharge: $" + rechargeAmount);
                    ...
                    if (transferAmount > 0 && transferAmount <= mobileBalance) {
                        ...
                        if (confirmTransfer == 1) {
                            ...
                            addTransaction("Transfer to " + recipientNumber + ": $" + transferAmount);
                    ...
                    if (selectedBundle == 1) {
                        ...
                        if (weeklyChoice == 1) {
                            if (5 <= mobileBalance) {
                                ...
                                if (confirmPurchase == 1) {
                                    mobileBalance -= 5;
                                    addTransaction("MIFI Weekly bundle (10GB) for " + mifiUser + ": $5");
                            ...
                            if (10 <= mobileBalance) {
                                ...
                                if (confirmPurchase == 1) {
                                    mobileBalance -= 10;
                                    addTransaction("MIFI Weekly bundle (25GB) for " + mifiUser + ": $10");
                        ...
                        if (dailyChoice == 1) {
                            if (1 <= mobileBalance) {
                                ...
                                if (confirmDaily == 1) {
                                    mobileBalance -= 1;
                                    addTransaction("MIFI Daily bundle (2GB) for " + dailyUser + ": $1");
                            ...
                            if (2 <= mobileBalance) {
                                ...
                                if (confirmDaily == 1) {
                                    mobileBalance -= 2;
                                    addTransaction("MIFI Daily bundle (5GB) for " + dailyUser + ": $2");
                        ...
                        if (mifiPlan == 1) {
                            if (20 <= mobileBalance) {
                                ...
                                if (confirmPlan == 1) {
                                    mobileBalance -= 20;
                                    addTransaction("MIFI Monthly bundle (40GB) for " + mifiPlanUser + ": $20");
                            ...
                            if (40 <= mobileBalance) {
                                ...
                                if (confirmPlan == 1) {
                                    mobileBalance -= 40;
                                    addTransaction("MIFI Monthly bundle (85GB) for " + mifiPlanUser + ": $40");
                            ...
                            if (60 <= mobileBalance) {
                                ...
                                if (confirmPlan == 1) {
                                    mobileBalance -= 60;
                                    addTransaction("MIFI Monthly bundle (150GB) for " + mifiPlanUser + ": $60");
                            ...
                            if (25 <= mobileBalance) {
                                ...
                                if (confirmPlan == 1) {
                                    mobileBalance -= 25;
                                    addTransaction("MIFI Unlimited Monthly bundle for " + mifiPlanUser + ": $25");
                    ...
                    if (internetAmount <= mobileBalance) {
                        ...
                        if (confirmInternet == 1) {
                            ...
                            addTransaction("Internet package purchase: $" + internetAmount);
                    ...
                    if (transferValue <= mobileBalance) {
                        ...
                        if (confirmTransfer == 1) {
                            ...
                            addTransaction("Transfer to " + mobileTransfer + ": $" + transferValue);
                ...
                if (billOption == 1) {
                    ...
                    if (postPaidChoice == 1) {
                        ...
                        if (billAmount <= mobileBalance) {
                            ...
                            if (confirmBill == 1) {
                                ...
                                addTransaction("Bill payment: $" + billAmount);
                        ...
                        if (billPayment <= mobileBalance) {
                            ...
                            if (confirmPayment == 1) {
                                ...
                                addTransaction("Bill payment for " + billMobile + ": $" + billPayment);
                    ...
                    if (purchaseAmount <= mobileBalance) {
                        ...
                        if (confirmPurchase == 1) {
                            ...
                            addTransaction("Business payment: $" + purchaseAmount);
            ...
            case 4:
                ...
                if (transferValue <= mobileBalance) {
                    ...
                    if (confirmTransfer == 1) {
                        mobileBalance -= transferValue;
                        addTransaction("Transfer to " + transferNumber + ": $" + transferValue);
                ...
                switch (miniStatement) {
                    case 1:
                        if (transactionCount > 0) {
                            System.out.println("Last transaction: " + transactionHistory[transactionCount - 1]);
                        } else {
                    ...
                    case 4:
                        ...
                        for (int i = Math.max(0, transactionCount - 3); i < transactionCount; i++) {
            ...
            case 6:
                ...
                if (bankOption == 1) {
                    addTransaction("Checked bank balance: $" + bankAccountBalance);
                    ...
                    if (confirmWithdrawal == 1) {
                        ...
                        addTransaction("Bank withdrawal: $" + withdrawalAmount);
                    ...
                    if (confirmTransfer == 1) {
                        ...
                        addTransaction("Bank transfer to 65467843: $" + transferAmount);
                    ...
                    if (confirmAccountTransfer == 1) {
                        if (bankAccountBalance >= accountTransfer) {
                            ...
                            addTransaction("Account transfer to 7353733: $" + accountTransfer);
            ...
            case 8:
                ...
                if (taajOption == 1) {
                    ...
                    if (companyChoice == 1) {
                        ...
                        if (confirmCharge == 1) {
                            ...
                            if (bankAccountBalance < transferAmount) {
                                ...
                                addTransaction("TAAJ transfer to " + recipientName + ": $" + transferAmount);
                        ...
                        if (confirmTransfer == 1) {
                            ...
                            if (confirmTransfer == 1) {
                                ...
                                if (bankAccountBalance < transferValue) {
                                    ...
                                    addTransaction("TAAJ transfer to " + recipientName + ": $" + transferValue);
                    ...
                    if (confirmInternational == 1) {
                        ...
                        if (confirmInternational == 1) {
                            ...
                            if (bankAccountBalance < internationalAmount) {
                                ...
                                addTransaction("International TAAJ transfer to " + internationalName + ": $" + internationalAmount);
                    ...
                    if (confirmService == 1) {
                        ...
                        addTransaction("TAAJ service payment to " + servicePhone + ": $" + serviceAmount);
                    ...
                    if (transferInfo != transferId) {
                        System.out.println("Invalid Input match (lengthbreak;");
                    } else {
                        System.out.println("Mahubtaa in aad xirto aqoonsiga xawilaada " + transferId + "?");
                        System.out.println("1. Haa");
                        System.out.println("2. Maya");
                    ...
                    if (billPaymentOption == 1) {
                        ...
                        if (BILL_REFERENCE != billReference) {
                            ...
                            if (confirmFullPayment == 1) {
                                ...
                                addTransaction("Full bill payment: $" + fullPayment);
                        ...
                        if (BILL_REFERENCE != billReference) {
                            ...
                            if (confirmPartial == 1) {
                                ...
                                addTransaction("Partial bill payment: $" + partialPayment);
    ...
    private static void addTransaction(String transaction) {
        if (transactionCount < transactionHistory.length) {
            ...
            // Shift all elements left to make room for new transaction
